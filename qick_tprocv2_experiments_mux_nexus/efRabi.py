        ...
        try:
            ...
            if config is not None:
                fig.text(plot_middle, 0.98,
                         f"Rabi Q{self.QubitIndex + 1}: {pi_amp} (a.u.) _"  + f", {config['reps']}*{config['rounds']} avgs",
                ...
                fig.text(plot_middle, 0.98,
                         f"Rabi Q{self.QubitIndex + 1}: {pi_amp} (a.u.)_" f", {self.config['sigma'] * 1000} ns sigma" + f", {self.config['reps']}*{self.config['rounds']} avgs",
