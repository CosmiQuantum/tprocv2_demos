...
class FtoResPulseProbeSpectroscopyProgram(AveragerProgramV2):
    ...
    def _body(self, cfg):
        ...
        self.delay_auto(t=0.01, tag='waiting after pi_ge')  # Wait til qubit pulse is done before proceeding
        self.pulse(ch=self.cfg["qubit_ch"], name="pi_ef", t=0)  # play ge pi pulse
        self.delay_auto(t=0.01, tag='waiting after pi_ef')  # Wait til qubit pulse is done before proceeding
