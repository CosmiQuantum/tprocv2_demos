...
outerFolder1 = os.path.join("/home/nexusadmin/qick/NEXUS_sandbox/Data/Run30/2025-02-19")
...
# punchout_thresholds = [0.204, 0.253, 0.119, 0.204]
punchout_thresholds = [0.34, 0.2, 0.146, 0.2]
