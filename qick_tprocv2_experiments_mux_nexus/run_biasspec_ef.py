...
from bias_qubit_spec_ef import EFBiasQubitSpectroscopy
...
for qindex in Qs:
    ...
    bias_spec = EFBiasQubitSpectroscopy(qindex, outerFolder, experiment, number_of_qubits)
