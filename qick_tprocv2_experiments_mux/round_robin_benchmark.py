...
run_name = 'run36'
device_name = '4charge'
substudy_txt_notes = ('R1 Q4 ro opt parameters, degen pt')
...
res_gain = [0.4, 0.36, 0.36, 0.425] #[0.3, 0.3, 0.3, 0.3] #[0.7, 0.375, 0.475, 0.5062] #Q4 0.475
