...
run_name = 'run36b'
device_name = '4charge'
substudy_txt_notes = ('Trying to debug signal with res spec, gain of 1') #('TOF at res freq, low gain (0.15) Fixed f+1 problem. Running res spec right after') #'R1 Q4 ro opt parameters, degen pt')
...
res_leng_vals = [4, 4, 4, 4] #[5.75, 5, 6.25, 6] #[4.75, 4, 4, 5] #Q4 4
res_gain = [1, 1, 1, 1] #[0.4, 0.4, 0.4, 0.4] #[0.35, 0.36, 0.36, 0.425] #[0.3, 0.3, 0.3, 0.3] #[0.7, 0.375, 0.475, 0.5062] #Q4 0.475
...
sub_study = 'ResSpec' #'TOF_punchout'#'RR_Q4_postopt'
