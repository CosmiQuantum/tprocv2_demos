...
# For 25dB DAC, 4/21
res_leng_vals = [5.6, 6.0, 5.7, 6.85, 6.5, 8.5]  # 25dB [5.6, 6.0, 5.75, 6.9, 6.5, 7.6]
res_gain = [0.825, 0.835, 0.915, 0.635, 0.95, 0.97]  # 25dB, [0.825, 0.835, 0.912, 0.635, 0.95, 1.0]
...
sub_study = 'AB_paper_data_batch7_25dB_DACatten_noQ5' # DACatten_SSF_inv_allQs_25dB_junk, AB_paper_data_batch3_25dB_DACatten_noQ5, AB_paper_data_25dB_DACatten_noQ5_batch1, AB_paper_data_25dB_DACatten_onlyQ4_batch2
            ...
            if ef_qspec_survived and ef_res_spec_survived:
                ...
                try:
                    ...
                    if QubitIndex == 5:
                        ...
                        increase_qubit_reps2_rpm_to = 5000
                    #
                    if QubitIndex == 4:
                        increase_qubit_reps2_rpm = True
