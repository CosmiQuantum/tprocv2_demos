...
# For Quiet
substudy = "optimizing_readout_post_new_channel_21_dBDAC"#unmasking_resgain"
...
for QubitIndex in Qs:
    ...
    experiment = QICK_experiment(outerFolder, DAC_attenuator1 = 10, DAC_attenuator2 = 11, qubit_DAC_attenuator1 = 5,
