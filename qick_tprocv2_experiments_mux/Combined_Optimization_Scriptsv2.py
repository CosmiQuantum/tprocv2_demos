...
res_leng_vals = [5.0, 6.0, 5.0, 5.0] #Only Q2 optimized
res_gain = [0.83, 0.8, 0.73, 0.8] # from punchout, not optimized
freq_offsets = [0, 0, 0, 0] #
punch_out_vals = [0.9, 0.9, 0.8, 0.9] # from punchout, not precise

optimal_lengths = [6.0, 6.0, 5, 5] #[None] * 4 # only Q2 found, creates list where the script will be storing the optimal readout lengths for each qubit
...
for QubitIndex in Qs:
    ...
    optimal_lengths = [6.0, 6.0, 5, 5] #only Q2 optimized
