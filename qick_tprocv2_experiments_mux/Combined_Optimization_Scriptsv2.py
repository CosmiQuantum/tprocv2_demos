...
# For Quiet
substudy = "optimizing_readout_post_new_channel_18_dBDAC"#unmasking_resgain"
...
# For 18dB DAC
res_leng_vals = [6.5, 9.0, 7.5, 6.5, 7.5, 7.5]
res_gain = [0.85, 0.7750, 0.85, 0.3, 0.5875, 0.7375] #[ new punchout t
freq_offsets = [-0.0462, 0.1385, -0.5077, -0.4154, -0.4154, -0.2308]
...
for QubitIndex in Qs:
    ...
    experiment = QICK_experiment(outerFolder, DAC_attenuator1 = 8, DAC_attenuator2 = 11, qubit_DAC_attenuator1 = 5,
...
#     optimal_lengths = [6.5, 9.0, 7.0, 7.0, 8.5, 7.5] #optional # DAC 2 optimization
...
#         gain_range = [0.7, 1.0]
#         gain_steps = 8
#     elif QubitIndex == 1 or  QubitIndex == 4 or QubitIndex == 5:
