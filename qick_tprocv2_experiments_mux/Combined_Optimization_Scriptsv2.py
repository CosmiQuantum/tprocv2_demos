...
run_name ='run33d'
device_name = '4charge'
substudy = "optimization_Q2" #unmasking_resgain"
...
res_leng_vals = [5.1, 5, 4, 3.6] #[9.5, 5.5, 6.25, 7.0] # Q1, Q4 reopt
res_gain = [0.115, 0.1, 0.15, 0.19] #[0.9, 0.7, 0.8, 0.8] # Q1, Q4 reopt
freq_offsets = [0.1364, -2, 0, -0.1364] #[-0.1429, -0.1429, 0, -0.04] # Q1, Q2, Q4 opt r1
punch_out_vals = [0.12, 0.1, 0.12, 0.17] # from punchout, not precise
...
for QubitIndex in Qs:
    ...
    optimal_lengths = [5.1, 5, 6.25, 3.6] #Q1 re-optimized
