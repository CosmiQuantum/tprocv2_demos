...
for QubitIndex in Qs:
    if QubitIndex == 0:
        lengs = np.arange(5.0, 5.6, 0.1)
    elif QubitIndex == 5:
        lengs = np.arange(6.6, 9.0, 0.2)
    elif QubitIndex == 3:
        lengs = np.arange(7.0, 8.0, 0.1)
    else:
        lengs = np.arange(6.0, 7.2, 0.1) # (5.2, 7.2, 0.2)
    ...
    if opt_flags["2d_sweep"]:
        ...
        if QubitIndex == 0:
            gain_range = [0.80, 0.83] #[0.70, 0.86]
            gain_steps = 6  # 11 # step = 0.015

        elif QubitIndex == 1:
            gain_range = [0.70, 0.805]
            gain_steps = 8  # step = 0.015

        elif QubitIndex == 2:
            gain_range = [0.75, 0.855]
            gain_steps = 8  # step = 0.015

        elif QubitIndex == 3:
            gain_range = [0.55, 0.655]
            gain_steps = 8  # step = 0.015

        elif QubitIndex == 4:
            gain_range = [0.70, 0.9]
            gain_steps = 16  # step = 0.015

        elif QubitIndex == 5:
            gain_range = [0.75, 0.85]
            gain_steps = 8
        ...
        if QubitIndex == 4:
            freq_range = [reference_frequency - 0.3, reference_frequency + 0.1]  # Frequency range in MHz
        else:
