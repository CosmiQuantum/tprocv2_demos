...
punch_out_vals = [0.95, 0.95, 1.0, 0.65, 1.0, 1.0] #updated 10/17/2025
...
#     optimal_lengths = [5.5, 8.0, 7.5, 5.0, 9.5, 8.0] #optional # DAC 2 optimization
...
#     #[0.95, 0.95, 1.0, 0.65, 1.0, 1.0]#
#     # Define sweeping parameters
#     if QubitIndex == 0 or QubitIndex == 1 or QubitIndex == 2 or QubitIndex == 4 or QubitIndex == 5:
#         gain_range = [0.6, 1.0]
#     elif QubitIndex == 3:
