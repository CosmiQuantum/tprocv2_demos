...
run_name ='run34'
device_name = '4charge'
substudy = "optimization_Q1" #unmasking_resgain"
...
res_leng_vals = [9.5, 5.5, 6.25, 7.0] # Q1, Q2, Q4 opt r1
res_gain = [0.9, 0.7, 0.8, 0.8] # Q1, Q2, Q4 opt r1
freq_offsets = [-0.1429, -0.1429, 0, -0.04] # Q1, Q2, Q4 opt r1
punch_out_vals = [0.85, 0.75, 0.8, 0.8] # from punchout, not precise

optimal_lengths = [9.5, 5.5, 6.25, 7.0] #[None] * 4 # Q2 found, creates list where the script will be storing the optimal readout lengths for each qubit
...
#     optimal_lengths = [9.5, 5.5, 6.25, 7.0] #Q1,2,3,4 optimized
