...
list_of_all_qubits = [3] #for QUIET [0, 1, 2, 3, 4, 5], for NEXUS [0, 1, 2, 3]
...
punch_out_vals = [1.0, 0.9, 0.9, 0.6, 0.525,0.85] #updated 10/16/2025
...
for QubitIndex in Qs:
    ...
    optimal_lengths = [6.5, 7.5, 7.5, 7.5, 8.0, 7.0] #optional # DAC 2 optimization
    ...
    if QubitIndex == 1 or QubitIndex == 2 or QubitIndex == 5:
        gain_range = [0.65, 0.95]
    elif QubitIndex == 0:
        gain_range = [0.7,1.0]  # Gain range in a.u.
