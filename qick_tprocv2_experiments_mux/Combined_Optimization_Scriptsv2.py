...
res_leng_vals = [6.5, 9.0, 9.0, 9.5, 9.5, 8.0]
res_gain = [0.9200, 0.8, 0.76, 0.6, 0.96, 0.92]
freq_offsets = [-0.3111, -0.1333, -0.3267, 0.0467, -0.4200, -0.0444]
punch_out_vals = [1.0, 0.9, 1.0, 0.65, 0.95, 1.0] #updated 10/22/2025
...
for QubitIndex in Qs:
    ...
    optimal_lengths = [6.5, 9.0, 9.0, 9.5, 9.5, 8.0] #optional # DAC 2 optimization
    ...
    if QubitIndex == 0 or QubitIndex == 2 or QubitIndex == 4 or QubitIndex == 5:
        gain_range = [0.6, 1.0]
    elif QubitIndex == 1:
        gain_range = [0.55, 0.95]
    elif QubitIndex == 3:
