...
h5_filename = '/data/QICK_data/6transmon_run6/2025-02-25/SingleShot_Test/qubit_4_data_20250225_110319.h5'  # Update with your file path
...
max_fidelity = max(avg_fidelities[:34])
...
plt.text(max_length + 0.1, max_fidelity-0.1, f'{max_length:.2f}', color='red')
#plt.text(max_length2 + 0.1, max_fidelity2-0.2, f'max length {max_length2:.2f}', color='green')
plt.xlabel('Readout and Pulse Length (us)')
plt.ylabel('Fidelity')
