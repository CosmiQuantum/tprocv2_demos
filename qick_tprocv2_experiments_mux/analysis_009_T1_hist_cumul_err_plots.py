...
class T1HistCumulErrPlots:
    def __init__(self, figure_quality, final_figure_quality, number_of_qubits, top_folder_dates, save_figs, fit_saved,
                 signal, run_name, run_notes, run_number, exp_config, fridge, list_of_all_qubits):
    ...
    def plot(self, dates, t1_vals, t1_errs, show_legends):
        ...
        plt.tight_layout()
        plt.savefig( analysis_folder + 'hists.png', transparent=False, dpi=self.final_figure_quality)
        ...
        plt.tight_layout()
        plt.savefig(analysis_folder + 'cumulative.png', transparent=False, dpi=self.final_figure_quality)
        ...
        for i, ax in enumerate(axes):
            ...
            ax.tick_params(axis='both', which='major', labelsize=font)
        plt.tight_layout()
        plt.savefig(analysis_folder + 'errs.png', transparent=False, dpi=self.final_figure_quality)
