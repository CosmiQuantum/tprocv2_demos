...
class HtoresQubitSpectroscopy:
    def __init__(self, QubitIndex, number_of_qubits,  outerFolder,  round_num, signal, save_figs, experiment = None,
        ...
        self.expt_name = "qubit_spec_htores"
        self.signal = signal
        ...
        if experiment is not None:
            ...
            print(f'Q {self.QubitIndex + 1} Round {self.round_num} Htores Qubit Spec configuration: ', self.config)
...
class FHPulseProbeSpectroscopyProgram(AveragerProgramV2):
    def _initialize(self, cfg):
        ...
        qubit_ampl_ch = cfg["qubit_ampl_ch"]
    ...
    def _body(self, cfg):
        ...
        self.pulse(ch=self.cfg["qubit_ampl_ch"], name="qubit_pulse", t=0)  # play f-h pulse
