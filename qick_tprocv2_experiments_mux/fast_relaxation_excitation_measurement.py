...
max_datataking_round_index = 1400
...
live_plot = False
study = 'FastRelEx'
sub_study = 'source_on_fast_relaxation_longexposure_substudy1'
substudy_txt_notes = 'Cesium-137 source in hot position. Delay 2 us and relax delay set to 5 us. 100% of nominal gain on res pulse. 500k reps and 200 rounds of fast relaxation data only.'
