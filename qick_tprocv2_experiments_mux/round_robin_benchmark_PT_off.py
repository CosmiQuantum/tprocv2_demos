...
substudy_txt_notes = ('Pre second PT shut off, Running purely SSF, no significant changes observed in res spec, q spec or rabi.\n')
...
run_flags = {"tof": False, "res_spec": False, "q_spec": False, "rabi": False, "ss": False,
             ...
             "rabi_pop_meas": False, "ef_Rabi": False, "t1": False, "t2r": False, "t2e": False,"correlation_method": True}
...
sub_study = 'Correlation_Debug' #batch2_post_1stopt_25dbDAC, opt_sigmas_gains_reps_steps, opt_AB_paper_data
...
while j < n:
    ...
    for QubitIndex in Qs_to_look_at:
        ...
        if run_flags["correlation_method"]:
            increase_qubit_reps_cor = False
            qubit_to_increase_cor_reps_for = QubitIndex
            multiply_cor_reps_by = 1
            t0 = time.perf_counter()
            rr_logger.info(
            ...
            #try:
                ...
                CorrelationMethod = Temps_CorrelationExperiment(QubitIndex, tot_num_of_qubits, studyDocumentationFolder, j, signal, save_figs,
                                                                ...
                                                                increase_qubit_reps = increase_qubit_reps_cor,
                                                                qubit_to_increase_reps_for = qubit_to_increase_cor_reps_for,
                                                                multiply_qubit_reps_by = multiply_cor_reps_by,
                                                                verbose = verbose, logger = rr_logger, unmasking_resgain = unmask)
