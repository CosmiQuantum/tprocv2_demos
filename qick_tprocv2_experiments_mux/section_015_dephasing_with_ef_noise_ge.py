...
class DephasingWithEFNoiseProgram(AveragerProgramV2):
    ...
    def _body(self, cfg):
        ...
        for dephasing_round in range(len(self.cfg["dephasing_rounds_plus_1"]-1)):
...
class DephasingMeasurementWithEFNoise:
