...
from analysis_021_plot_Qspec_RPMs_noqick import PlotRR_noQick
import os
...
plotter = PlotRR_noQick(date, figure_quality, save_figs, fit_saved, signal, run_name, tot_num_of_qubits, outerFolder,
