    ...
    def run_sweep(self, freq_range, gain_range, freq_steps, gain_steps):
        ...
        for freq_step in range(freq_steps):
            ...
            for gain_step in range(gain_steps):
                ...
                round_num = 0
                save_figs = False
                single_shot = SingleShot_ef(self.qubit_index,  self.output_folder, round_num, save_figs, fresh_experiment) #SingleShot(self.qubit_index, self.output_folder, fresh_experiment, round_num=0, save_figs = False)
