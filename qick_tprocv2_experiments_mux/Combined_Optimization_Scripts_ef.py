...
#     list_of_all_qubits = [0, 1, 2, 3, 4, 5]
    ...
    #
    # experiment = copy.deepcopy(tuned_experiment)
    # sweep = GainFrequencySweep(QubitIndex, number_of_qubits, n_loops, list_of_all_qubits, experiment, save_figs, optimal_lengths=optimal_lengths, output_folder=output_folder, unmasking_resgain = unmask)
