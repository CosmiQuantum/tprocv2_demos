...
from R33_tomography_h5 import TomographyMeasurement
...
run_name = 'run35'
device_name = '4charge'
study =  'Tomography_Check' #'Cs_TimeStudy_Tomography_2'#'Cs_TimeStudy_Tomography' #'SC_Tomography' #'DDon_SC_HoleClosed_noCol' #'Tomography' #
