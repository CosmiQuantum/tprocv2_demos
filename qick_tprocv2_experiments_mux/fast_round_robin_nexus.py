...
import datetime
import time
sys.path.append(os.path.abspath("/home/nexusadmin/Documents/GitHub/tprocv2_demos/qick_tprocv2_experiments_mux/"))  #NEXUS
...
# For NEXUS
res_leng_vals = [4.6, 4.5, 5.20, 5.20] # from 2/25/2025 optimization
res_gain = [0.35, 0.35, 0.35, 0.35] # from 2/25/2025 optimization
freq_offsets = [-0.3, -0.1667, 0.1667, 0.3] # from 2/25/2025 optimization
####################################################### RR #############################################################
...
for QubitIndex in Qs_to_look_at:
    ...
    res_spec   = ResonanceSpectroscopy(QubitIndex, number_of_qubits, list_of_all_qubits, outerFolder, 0, save_figs, experiment)
    ...
    q_spec = QubitSpectroscopy(QubitIndex, number_of_qubits, list_of_all_qubits, outerFolder, 0, signal, save_figs, experiment, live_plot)
    ...
    rabi = AmplitudeRabiExperiment(QubitIndex, number_of_qubits, list_of_all_qubits, outerFolder, 0, signal, save_figs, experiment, live_plot,
