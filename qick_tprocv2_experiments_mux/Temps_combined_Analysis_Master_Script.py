...
outerFolder_qtemps_plots_RR_run6 = "/exp/cosmiq/data/home/cosmiq/Analysis_on1hw_temporary/acolonce/QTemperatures/Plots/qtemps_hists/run6_analysis"
# For RPM Analysis
...
outerFolder_qtemps_plots_run6 = "/exp/cosmiq/data/home/cosmiq/Analysis_on1hw_temporary/acolonce/QTemperatures/Plots/qtemps_hists/run6_analysis" # Inside each analysis function, a subfolder will be defined
...
# To re-make and save RPM RR plots
outerFolder_qtemps_plots_RR_run8 = "/data/QICK_data/run8/6transmon/round_robin/AB_paper_datadump_for_analysis/benchmark_analysis_plots/RPM_RR_plots"
...
#
# For RPM Analysis
outerFolder_qtemps_plots_run8 = "/data/QICK_data/run8/6transmon/round_robin/AB_paper_datadump_for_analysis/benchmark_analysis_plots/Qtemps_RPMmethod" # Inside each analysis function, a subfolder will be defined
...
if qtemp_method_flags["Qtemps_viaRPM"]:
    ...
    if analysis_flags["Qtemps_vs_time_viaRPM"]:
        ...
        RPM_plotter.plot_qubit_temperatures_vs_time_RPMs(combined_qtemp_data, num_qubits=tot_num_of_qubits, yaxis_min = 10, yaxis_max = 750, rel_err_cutoff = 0.5, restrict_time_xaxis = False,
    ...
    if analysis_flags["Qtemps_hists_viaRPM"]:
        ...
        RPM_plotter.plot_qubit_temperature_histograms_RPMs(combined_qtemp_data, num_qubits=6)
