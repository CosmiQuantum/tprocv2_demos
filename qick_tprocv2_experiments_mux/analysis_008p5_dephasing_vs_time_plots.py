...
class DephasingVsTime:
    ...
    def run(self,return_errs=False,return_noise_gain=False):
        import datetime
        ...
        for folder_date in self.top_folder_dates:
            ...
            # -------------------------------------------------------Load/Plot/Save T2E------------------------------------------
            outerFolder_expt = outerFolder + "/Data_h5/Dephased_ge/"
        ...
        if return_errs:
            ...
            return date_times, t2e_vals, noise_gains
        else:
