...
# Updated for APS
Pe_meas = [
    [None, 0.262206, 0.122347, 0.080209, 0.056575, 0.0110],  # Qubit 1
    [None, 0.379916, 0.103899, 0.088050, 0.080829, 0.0230],  # Qubit 2
    [None, 0.230638, 0.137551, 0.076606, 0.073828, 0.0252],  # Qubit 3
    [None, 0.355278, 0.170338, 0.088298, 0.111364, 0.0242],  # Qubit 4
    [None, 0.220639, 0.061004, 0.080564, 0.052125, None],    # Qubit 5
    [None, 0.248520, 0.068520, 0.046608, 0.029532, 0.0078],  # Qubit 6
]

Pe_err = [
    [None, 0.038575, 0.020341, 0.005599, 0.002620, 0.0009],  # Qubit 1
    [None, 0.010940, 0.005009, 0.002714, 0.003743, 0.0011],  # Qubit 2
    [None, 0.010852, 0.017270, 0.002867, 0.005371, 0.0013],  # Qubit 3
    [None, 0.008452, 0.016899, 0.004802, 0.015093, 0.0012],  # Qubit 4
    [None, 0.007670, 0.020126, 0.003180, 0.003983, None],    # Qubit 5
    [None, 0.007161, 0.003828, 0.003404, 0.003975, 0.0003],  # Qubit 6
]

# ------------------------------------------------------------
# Qubit frequencies (MHz) (Run 4 column will be dropped to match Pe data)
# ------------------------------------------------------------
# updated to use medians from box plots and IQR/2. Used final data from run 9
# rows = qubits 1-6
# columns = runs 4-9
...
# -------------------------------------------------------------------------
ssf_fid_vals = [
    [0.41, 0.70, 0.77, 0.81],  # Qubit 1
    [0.35, 0.57, 0.73, 0.71],  # Qubit 2
    [0.46, 0.55, 0.76, 0.73],  # Qubit 3
    [0.37, 0.55, None, None],  # Qubit 4
    [0.45, 0.73, 0.75, 0.76],  # Qubit 5
    [0.48, 0.71, None, None],  # Qubit 6
]

ssf_fid_errs = [
    [0.05, 0.03, 0.01, 0.01],  # Qubit 1
    [0.01, 0.02, 0.01, 0.01],  # Qubit 2
    [0.01, 0.01, 0.01, 0.01],  # Qubit 3
    [0.01, 0.04, None, None],  # Qubit 4
    [0.01, 0.06, 0.01, 0.01],  # Qubit 5
    [0.01, 0.02, None, None],  # Qubit 6
]
