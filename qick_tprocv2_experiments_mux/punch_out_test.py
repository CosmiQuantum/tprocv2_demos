...
for QubitIndex in Qs:
    if QubitIndex == 0:
        start_gain, stop_gain, num_points = 0.2, 1.0, 8 # 0.8, 0.97, 5
    elif QubitIndex == 1:
        start_gain, stop_gain, num_points = 0.2, 1.0, 8 # 0.74, 0.79, 5
    elif QubitIndex == 2:
        start_gain, stop_gain, num_points = 0.2, 1.0, 8 # 0.95, 0.99, 4
    elif QubitIndex == 3:
        start_gain, stop_gain, num_points = 0.2, 1.0, 8# 0.45, 0.47, 3
    elif QubitIndex == 4:
        start_gain, stop_gain, num_points = 0.2, 1.0, 8 # 0.5, 1.0, 5
    elif QubitIndex == 5:
        start_gain, stop_gain, num_points = 0.2, 1.0, 8 # 0.85,0.9, 4
    else:
