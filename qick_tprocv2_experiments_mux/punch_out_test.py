...
for QubitIndex in Qs:
    ...
    if QubitIndex == 0:
        start_gain, stop_gain, num_points =  0.70, 0.86, 5 # 0.8, 0.97, 5
    elif QubitIndex == 1:
        start_gain, stop_gain, num_points =  0.70, 0.805, 5# 0.74, 0.79, 5
    elif QubitIndex == 2:
        start_gain, stop_gain, num_points =  0.75, 0.855, 5 # 0.95, 0.99, 4
    elif QubitIndex == 3:
        start_gain, stop_gain, num_points =  0.55, 0.655, 5 # 0.45, 0.47, 3
    elif QubitIndex == 4:
        start_gain, stop_gain, num_points = 0.70, 1.00,5 # 0.5, 1.0, 5
        # increase_geres_reps = True
        # increase_geres_reps_to = 1200
    elif QubitIndex == 5:
        start_gain, stop_gain, num_points = 0.75, 0.85, 5 # 0.85,0.9, 4
    else:
