...
substudy = 'Punchout'
outerFolder = os.path.join(f"/home/nexusadmin/Documents/Data/run33d/4charge/Initial Checkout/{substudy}/{datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}/")
...
for Q in qubits:
    ...
    start_gain, stop_gain, num_points = 0.01, 0.3, 15 # for NEXUS
