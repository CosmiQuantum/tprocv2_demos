...
def add_qubit_channel(system_config, QubitIndex):
    ...
    var = ["qubit_ch", "qubit_ampl_ch", "res_ch", "ro_ch", "qubit_ch_ef","qubit_ch_fh"]#,"qubit_ch_fh"
    for Index in var:
...
def add_readout_cfg(system_config, QubitIndex):
    ...
    var = ["res_freq_ge", "res_gain_ge", "res_phase", "res_freq_ef", "res_gain_ef","res_freq_fh", "res_gain_fh"] # "res_freq_fh", "res_gain_fh"
    for Index in var:
...
def add_qubit_cfg(system_config, QubitIndex):
    ...
    var = ["qubit_freq_ge", "qubit_gain_ge","qubit_freq_ef", "qubit_gain_ef","qubit_freq_fh", "qubit_gain_fh", "sigma",
           "sigma_ef","sigma_fh", "pi_amp", "pi_ef_amp" ,"pi_fh_amp" , 'qubit_freq_ftores', 'qubit_gain_ftores',  "qubit_length_ftores"]
    for Index in var:
