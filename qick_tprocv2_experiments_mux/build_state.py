...
def add_readout_cfg(system_config, QubitIndex):
    ...
    var = ["res_freq_ge",  "res_gain_ge", "meas_freq_ge", "meas_gain_ge", "rqubit_phase", "res_phase",  "res_freq_ef", "res_gain_ef", "meas_freq_ge", "meas_gain_ge",]#, "mixer_freqs"] # "threshold"]
    for Index in var:
...
def add_qubit_cfg(system_config, QubitIndex):
    ...
    var = ["qubit_freq_ge", "qubit_gain_ge",  "meas_freq_ge", "meas_gain_ge", "meas_phase", "sigma", "sigma_ef", "sigma_fh", "pi_amp", "pi_ef_amp", "pi_fh_amp" , "qubit_freq_ef", "qubit_freq_eh",  "qubit_gain_ef", "qubit_gain_eh", "qubit_freq_fh",  "qubit_gain_fh", 'qubit_freq_ftores', 'qubit_gain_ftores',  "qubit_length_ftores", 'qubit_freq_htores', 'qubit_gain_htores',  "qubit_length_htores"]
    for Index in var:
