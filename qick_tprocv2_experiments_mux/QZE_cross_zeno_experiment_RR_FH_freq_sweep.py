...
formatted_datetime = 'fh_freq_offset_sweep_100nsNoisePulse_'+ datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
            ...
            try:
                ...
                (t2r_est_w_noise, t2r_err_w_noise, t2r_I_w_noise, t2r_Q_w_noise, t2r_delay_times_w_noise,
                 fit_ramsey_w_noise, sys_config_t2r_w_noise) = t2r_w_noise.run(
                    thresholding=thresholding, noise_type='fh', offset=freq)
                del t2r_w_noise
        ...
        if save_data_h5:
            ...
            if run_flags["t1_fe_w_noise"]:
                ...
                t1_data_ef_w_noise[QubitIndex]['Delay Times'][
                    j - batch_num * save_r - 1] = t1_delay_times_fe_w_noise
