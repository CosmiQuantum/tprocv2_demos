...
if FRIDGE == "QUIET":
    ...
    expt_cfg = {
        ...
        "power_rabi_ef": {
            "reps": 500,#400, # for Pg pulse sequence during rpm, or regular ef rabi
            "reps2": 1200, #this is only used for the experiment that uses e-f rabi to calculate qubit temperatures (rpm). Pe pulse sequence
            "rounds": 1,
