...
if FRIDGE == "QUIET":
    ...
    expt_cfg = {
        ...
        # "qubit_spec_ge": { #test the high gain thing
        #     "reps": 2000,  # 300
        #     "rounds": 1,  # 10
        #     "start": [3700]*6,  # [MHz] #-300 #-15
        #     "stop": [4250]*6,  # [MHz] #+15
        #     "steps": 2000,  # 100
        #     "relax_delay": 10,  # 1000, # [us]
        #     "list_of_all_qubits": list_of_all_qubits,
        ...
        # "qubit_spec_fh": { #test the high gain thing
        #     "reps": 2000,  # 300
        #     "rounds": 1,  # 10
        #     "start": [3700]*6,  # [MHz] #-300 #-15
        #     "stop": [4250]*6,  # [MHz] #+15
        ...
        "T1_ge": {
            ...
            "rounds": 1, #1
            "start": [0.0] * 6,  # [us]
            "stop": [300]*6, #[250.0] * 6,  # [us] ### Should be ~10x T1! Should change this per qubit.
            "steps": 60,
        ...
        "T1_fe": {
            ...
            "rounds": 1,  # 1
            "start": [0.0] * 6,  # [us]
            "stop": [100] * 6,  # [250.0] * 6,  # [us] ### Should be ~10x T1! Should change this per qubit.
            "steps": 150,
            "relax_delay": 1000,  # [us] ### Should be >10x T1!
            "wait_time": 0.0,  # [us]
            "list_of_all_qubits": list_of_all_qubits,
        ...
        "T1_ge_with_ef_noise": {
            ...
            "rounds": 1, #1
            "start": [0.0] * 6,  # [us]
            "stop": [350]*6, #[250.0] * 6,  # [us] ### Should be ~10x T1! Should change this per qubit.
            "steps": 60,
            "relax_delay": 1000,  # [us] ### Should be >10x T1!
            "wait_time": 0.0,  # [us]
            "list_of_all_qubits": list_of_all_qubits,
