...
if FRIDGE == "QUIET":
    ...
    VNA_qubit = np.array([4226.11, 3853.61, 4197.05, 4506.61, 4509.0, 5050.78])  # run 9, all updated except Q5 (run 8: 4485.38 for Q5 and 4474.23 for Q4)
    ...
    expt_cfg = {
        ...
        "power_rabi_ef": {
            "reps": 270,#400, # for Pg pulse sequence during rpm, or regular ef rabi
