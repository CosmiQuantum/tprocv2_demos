...
if FRIDGE == "QUIET":
    VNA_res = np.array([6236.357-0.2, 6296.685, 6358.140, 6427.895, 6494.4, 6562.500]) # run 9c: [6235.097, 6295.745, 6356.840, 6426.675, 6493.5, 6561.2]
    VNA_qubit = np.array([4228.42, 3852.44, 4201.97, 4506.32, 4518.33, 5054.72])  # run 9c: 4229.89, 3853.24, 4197.02, 4500.9, 4515.34, 5054.02
    ...
    expt_cfg = {
        ...
        "qubit_spec_ge": { # RR
            "reps": 500, #300
            "rounds": 1, #10
            "start": list(VNA_qubit-1.25), # [MHz], -2.0
            "stop": list(VNA_qubit+1.25), # [MHz], +2.0
            "steps": 150, # 215 for -2 +2, 220 for -3 +3, 400 for -40, +40, 320 for -6 +6
            "relax_delay":10,#1000 # [us]
            "list_of_all_qubits": list_of_all_qubits,
        },
        ...
        "qubit_spec_ef": {
            "reps": 1600,  # 2200
            "rounds": 1,  # 10
            "start": list(ef_qfreqs - 4),  # [MHz] #-4
            "stop": list(ef_qfreqs + 4),  # [MHz] +4
            "steps": 200, # 200 for -4 +4
            "relax_delay": 900, #1000,  # [us]
            "list_of_all_qubits": list_of_all_qubits,
        },
        "qubit_spec_fh": {
        ...
        "power_rabi_ef": {
            "reps": 280,#120,400 # for Pg pulse sequence during rpm, or regular ef rabi
            "reps2": 5000, #5500 #this is only used for the experiment that uses e-f rabi to calculate qubit temperatures (rpm). Pe pulse sequence
            "rounds": 1,
            "start": [0.0] * 6,  # [DAC units]
            "stop": [1.0] * 6,  # [DAC units]
            "steps": 90, #110, 80 (run 9a)
            "relax_delay": 900,  # [us]
        },
        "power_rabi_fh": {
            "reps": 200,
