...
if FRIDGE == "QUIET":
    ...
    htores_freqs = np.array([4020.48, 4650, 3999.01, 4303.08, 4313.19, 4848.81])
    ...
    expt_cfg = {
        ...
        "qubit_spec_ge": {
            "reps": 500, #300
            "rounds": 1, #10
            "start": list(VNA_qubit-8), # [MHz] #-300 #-15
            "stop": list(VNA_qubit+8), # [MHz] #+15
            "steps": 200, #100
        ...
        "qubit_spec_eh": {
            "reps": 4000,  # 300
            "rounds": 1,  # 10
            "start": list(eh_freqs - 10),  # [MHz] #-300
            "stop": list(eh_freqs + 10),  # [MHz]
            "steps": 300,
            "relax_delay": 1000,  # 1000,  # [us]
            "list_of_all_qubits": list_of_all_qubits,
        },
