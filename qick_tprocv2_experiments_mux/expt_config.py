...
if FRIDGE == "QUIET":
    ...
    expt_cfg = {
        ...
        "multi_res_timestream": {
            "reps": 1,  # cycles through sending pulse/triggering one dynro channel
            "relax_delay": 0.01,  # relax delay in us. can be 0? for res spec
            "pulse_length": 10.0,  # mux pulse length in us.
            "period": 0.00325,  # time to acquire one I,Q data point in us.
    ...
    #         "rounds": 1,
    #         "list_of_all_qubits": list_of_all_qubits,
    #         "relax_delay": 5.0, #[us], keep short to do post-processing
    #         "meas_wait": 2.0, #[us], a fast delay after qubit pi pulse
