...
res_length_us = 4.0104
dec_mhz_rounded = 38.400
dec_mhz_exact   = 38.400000000000006

print(np.trunc(res_length_us * dec_mhz_rounded))  # 153
print(np.trunc(res_length_us * dec_mhz_exact))    # 154