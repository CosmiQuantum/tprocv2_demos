...
def add_single_qubit_experiment(expt_cfg, expt_name, QubitIndex):
    ...
    elif (expt_name == 'Ramsey_ge' or expt_name == 'SpinEcho_ge' or expt_name == 'Dephasing_ge'
          or expt_name == 'Dephasing_ge_with_ef_noise' or expt_name == 'Dephasing_ge_with_fh_noise'
          or expt_name == 'T1_ge' or expt_name == 'T1_fg'
          or expt_name == 'T1_fe' or expt_name == 'T1_fh' or expt_name == 'Ramsey_ef' or expt_name == 'Ramsey_stark'
          or expt_name == 'SpinEcho_ge_with_fh_noise' or expt_name == 'SpinEcho_ge_with_ef_noise'
          or expt_name == 'T1_ge_with_fh_noise' or expt_name == 'T1_ge_with_ef_noise'
          or expt_name == 'T1_fe_with_fh_noise' or expt_name == 'T1_fe_with_ef_noise'
          or expt_name == 'T1_fh_with_fh_noise' or expt_name == 'T1_fh_with_ef_noise'
          or expt_name == 'Ramsey_ge_with_fh_noise' or expt_name == 'Ramsey_ge_with_ef_noise'):
