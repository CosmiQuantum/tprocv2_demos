...
##----------------------------------------------------------------------------------------------
# Overarching Fast-Time-Series 



## Overarching class definition for the McEwen-style sweep
class FastTimeSeriesMcEwenProgram(AveragerProgramV2):
    def _initialize(self, cfg):
        ro_chs = cfg['ro_chs']
        gen_ch = cfg['res_ch']
        qubit_ch = cfg['qubit_ch']

        ##Declare generators: the 
        ...
        for ch, f, ph in zip(cfg['ro_chs'], cfg['f_res'], cfg['ro_phase']):
            ...
            #REL why is the res_length not qubit specific here?
