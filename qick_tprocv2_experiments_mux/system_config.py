    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.qubit_cfg = {
                ...
                "qubit_gain_ge":  [0.055, 0.135, 0.45, 0.282, 0.295, 0.79],
                ...
                "qubit_gain_ef":  [0.0075, 0.011, 0.015, 0.068, 0.018, 0.03],# [0.004, 0.0075, 0.0045, 0.008, 0.01],#
                ...
                "sigma": [0.26, 0.43, 0.46, 0.42, 0.385, 1.01], # DAC 2 04/07 [us] for Gaussian Pulse (5+10 DAC atten for qubit). Updated on 7/17 by Arianna
                ...
                "sigma_ef": [0.196, 0.59, 0.45, 0.41, 0.32, 0.635],  # [us] for Gaussian Pulse, #Arianna 3/27
