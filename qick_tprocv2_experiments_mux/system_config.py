    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 11, qubit_DAC_attenuator1 = 2,
        ...
        if fridge == "QUIET":
            ...
            self.qubit_cfg = {
                ...
                "qubit_gain_ge":  [0.04, 0.05, 0.05, 0.08, 0.14, 0.17],
                ...
                "qubit_gain_ef":  [0.0055, 0.006, 0.0077, 0.0045, 0.0095, 0.02],# [0.004, 0.0075, 0.0045, 0.008, 0.01],#
                ...
                "sigma": [0.15, 0.3, 0.27, 0.26, 0.235, 0.57],  # DAC 2 04/07 [us] for Gaussian Pulse (5+10 DAC atten for qubit). Updated on 7/17 by Arianna
                ...
                "sigma_ef": [0.095, 0.3, 0.20, 0.125, 0.2, 0.27],  # [us] for Gaussian Pulse, #Arianna 3/27
                "sigma_fh": [0.15, 0.3, 0.25, 0.29, 0.28, 0.5],  # [us] for Gaussian Pulse, #Arianna 3/27
                "pi_amp": [0.66, 0.595, 0.65, 0.65, 0.66, 0.69], # Arianna 10/10, run 8
