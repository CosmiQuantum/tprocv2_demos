...
class QICK_experiment:
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.qubit_cfg = {
                "qubit_mixer_freq": 4300,  # [MHz]
                "qubit_freq_ge": [4930.9, 4788.79, 4584.47, 4801.06], #NR36a: [4928.55, 4779.97, 4586.65, 4802.87], #NR35: [4943.4, 4773.45, 4578.95, 4805.35]  # Freqs of Qubit g/e Transition
                "qubit_gain_ge": [0.03, 0.03, 0.03, 0.03],  # [0.008] * 4,#[0.2, 0.2, 0.2, 0.01], #[0.2] * 4,  #0.07
                "qubit_length_ge": 20,  # [us] for spec Pulse
                "qubit_phase": 0,  # [deg]
                "sigma": [0.06, 0.045, 0.065, 0.05], #[0.6, 0.4, 0.65, 0.5],
                "pi_amp": [0.76, 0.765, 0.775, 0.81] #[0.765, 0.624, 0.655, 0.705], #Found 9/3 #[1.0, 0.93, 0.77, 0.846]
