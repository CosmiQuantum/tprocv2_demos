    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.qubit_cfg = {
                ...
                "qubit_gain_ge":  [0.011, 0.011, 0.033, 0.023, 0.028, 0.09], # [0.0135, 0.005, 0.005, 0.005, 0.082, 0.015] run 8
                ...
                "qubit_gain_ef":  [0.01, 0.016, 0.05, 0.028, 0.06, 0.16], # run 8: [0.0053, 0.01, 0.0077, 0.0045, 0.00955, 0.02],
