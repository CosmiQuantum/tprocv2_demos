    ...
    def __init__(self, folder, DAC_attenuator1 = 5, DAC_attenuator2 = 15, ADC_attenuator = 15, fridge = None):
        if fridge == "QUIET":
            ...
            self.readout_cfg = {
                ...
                'res_freq_ge': [6214.447, 6273.737, 6332.600, 6404.534, 6473.39, 6535.600], #Joyce 04/07 DAC 0
                ...
                # "res_phase": [ 1.281174 * 180/np.pi, -(1.62 * 180/np.pi), 85,
                #               0, 150,
                #             -90], #Joyce 3/11
                "res_phase": [1.281174 * 180 / np.pi, 0, 85, 0, 150,
                              -90],  # Joyce 3/11
            ...
            # Qubit Configuration
            self.qubit_cfg = {
                "qubit_freq_ge": [4190.49, 3819.35, 4161.38, 4461.86, 4473.17, 4999.64],  # Joyce 3/11
                ...
                "qubit_freq_ef": [4013.23, 3641.705, 3987.23, 4290.31, 4301.31, 4832.19],#[4016.3, 3644.76, 3988.44, 4292.73, 4303.18, 4833.17], #Q4 not fixed, looks like it shifted quite a lot
                ...
                "qubit_freq_ftores": [4016.3, 1254.73, 3988.44, 4292.73, 4303.18, 4833.17],
                "qubit_gain_ef": [0.0005]*6,#[0.001]*6,#[0.03, 0.14, 0.04, 0.17, 0.11, 0.08], #Arianna 3/27. 0.03
                "qubit_gain_fh": [0.001]*6,#[0.03, 0.000, 0.01, 0.17, 0.11, 0.08],  # Olivia May 28
                'qubit_gain_ftores': [0.5]*6,#[0.2, 0.14, 0.04, 0.17, 0.13, 0.08],
                ...
                "sigma_ef": [0.09, 0.2, 0.16, 0.15, 0.15, 0.10],  # [us] for Gaussian Pulse, #Arianna 3/27
                "pi_amp": [0.1206, 0.138, 0.1174, 0.1396, 0.1206, 0.158], #[0.6748, 0.634499, 0.76542, 0.7754, 0.6546, 0.9], #Joyce 3/11
                ...
                "pi_ef_amp": [0.1088, 0.14, 0.0956, 0.0898, 0.1005, 0.1228],#[0.7085, 0.6817, 0.6617, 0.7018, 0.6751, 0.6951], # Arianna 3/27
                "pi_fh_amp": [0.001]*6,#[0.2, 0.001, 0.2, 0.2, 0.2, 0.2],  # Olivia 5/25
                "pi_f2res_amp": [0.3]*6,
                "sigma_f2res": [0.09, 0.2, 0.16, 0.15, 0.15, 0.10],  # [us] for
