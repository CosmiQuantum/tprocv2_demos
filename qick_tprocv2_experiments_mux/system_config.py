    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.qubit_cfg = {
                ...
                "qubit_gain_ge":  [0.0135, 0.005, 0.005, 0.005, 0.062, 0.005], # 19 dB: [0.055, 0.135, 0.45, 0.282, 0.295, 0.79],
                ...
                "sigma": [0.14, 0.25, 0.2, 0.2, 0.22, 0.2], # 19dB: [0.26, 0.43, 0.46, 0.42, 0.385, 1.01], # DAC 2 04/07 [us] for Gaussian Pulse (5+10 DAC atten for qubit). Updated on 7/17 by Arianna
                ...
                "sigma_ef": [0.1, 0.25, 0.2, 0.1, 0.17, 0.2],# 19dB: [0.196, 0.59, 0.45, 0.41, 0.32, 0.635],  # [us] for Gaussian Pulse, #Arianna 3/27
