    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.qubit_cfg = {
                ...
                "qubit_gain_ge": [0.04, 0.05, 0.05, 0.08, 0.15, 0.17],#[0.04, 0.12, 0.06, 0.04, 0.13, 0.18],#[0.05] * 6, #[1] * 6,
                ...
                "qubit_gain_ef":  [0.0055, 0.006, 0.0075, 0.0045, 0.008, 0.01],# [0.004, 0.0075, 0.0045, 0.008, 0.01],#
