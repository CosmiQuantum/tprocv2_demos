    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.qubit_cfg = {
                ...
                "qubit_gain_ge":  [0.02, 0.018, 0.13, 0.1, 0.2, 0.43], #0.1 for Q4 # run 9, # [0.0135, 0.005, 0.005, 0.005, 0.082, 0.015] run 8
                ...
                "qubit_gain_ef":  [0.08, 0.018, 0.15, 0.1, 0.2, 0.41], # run 8: [0.0053, 0.01, 0.0077, 0.0045, 0.00955, 0.02],
