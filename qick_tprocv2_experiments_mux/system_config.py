    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 11, qubit_DAC_attenuator1 = 2,
        ...
        if fridge == "QUIET":
            ...
            self.readout_cfg = {
                ...
                'res_freq_ge': np.array([6227.125, 6289.150, 6348.55, 6419.665, 6485.315, 6552.35]), #updated by Arianna 10/10, run 8
            ...
            self.qubit_cfg = {
                ...
                "qubit_freq_ef": [4020.47, 3650.78, 3999.01, 4302.33, 4313.20, 4848.81], # Arianna 10/13
