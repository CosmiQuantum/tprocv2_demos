    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.readout_cfg = {
                ...
                'res_freq_ge': [6236.137, 6296.685, 6358.140, 6427.895, 6494.4, 6562.500], # run 9c: 6235.097, 6295.745, 6356.840, 6426.675, 6493.5, 6561.2
            ...
            # Qubit Configuration
            self.qubit_cfg = {
                "qubit_freq_ge":  [4228.49, 3852.44, 4201.97, 4506.32, 4518.33, 5054.72], # run 9c: 4229.89, 3853.24, 4197.02, 4500.9, 4515.34, 5054.02
                ...
                "pi_amp": [0.831105, 0.68, 0.65, 0.65, 0.66, 0.69], # Arianna 10/10, run 8
