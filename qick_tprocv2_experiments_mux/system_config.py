    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.readout_cfg = {
                ...
                "res_gain_ge": [0.8, 0.85, 0.7, 0.8], #[0.4, 0.4, 0.4, 0.4],  # [0.15]*4, #[1, 1, 1, 1],
                "res_length": 5.0, #4.6,  # 10,  # [us] (1.0 for res spec)
                "res_phase": [0] * 4,
            ...
            self.qubit_cfg = {
                "qubit_mixer_freq": 4300,  # [MHz]
                "qubit_freq_ge": [4921.5, 4761.7, 4575.8, 4784], #Found with QICK, 9/3 #[4909, 4749.4, 4569, 4756],  # Freqs of Qubit g/e Transition
                "qubit_gain_ge": [0.2, 0.2, 0.2, 0.2],  # [0.008] * 4,#[0.2, 0.2, 0.2, 0.01], #[0.2] * 4,  #0.07
                "qubit_length_ge": 20,  # [us] for spec Pulse
                "qubit_phase": 0,  # [deg]
                "sigma": [0.5, 0.35, 0.5 ,0.5], #[0.04, 0.025, 0.04, 0.03],  # [0.08, 0.15, 0.11, 0.09], # TO DO CHANGE THIS (11/26)
                "pi_amp": [0.87, 0.85, 0.6, 0.75], #Found 9/3 #[1.0, 0.93, 0.77, 0.846],  # TO DO CHANGE THIS (11/26)
