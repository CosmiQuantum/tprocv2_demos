    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.readout_cfg = {
                ...
                'res_freq_ge': [6235.097, 6295.745, 6356.840, 6426.675, 6493.5, 6561.2], #[6228.837, 6290.125, 6349.800, 6420.615, 6486.0, 6553.100], # run 9a
            ...
            # Qubit Configuration
            self.qubit_cfg = {
                "qubit_freq_ge":  [4229.89, 3853.24, 4197.02, 4500.9, 4515.34, 5054.02], #run 9 [4226.11, 3853.61, 4197.05, 4506.61, 4519.0, 5050.78], # Run 8:[4194.77, 3828.69, 4173.69, 4474.23, 4485.38, 5018.12]
                ...
                "qubit_freq_ef": [4055.94, 3675.69, 4022.54, 4329.42, 4343.53, 4886.5], # run 9# [MHz] Freqs of Qubit e/f Transition
                ...
                "qubit_gain_ef":  [0.01, 0.016, 0.076, 0.028, 0.1, 0.15], # run 8: [0.0053, 0.01, 0.0077, 0.0045, 0.00955, 0.02],
                ...
                "sigma": [0.11, 0.05, 0.19, 0.21, 0.35, 0.98], #  run 9c: [0.11, 0.05, 0.19, 0.21, 0.35, 0.98] # DAC 2
                ...
                "sigma_ef": [0.12, 0.22, 0.42, 0.23, 0.16, 0.8], #run 9: updated all except Q5 # run 8: [0.1, 0.25, 0.2, 0.25, 0.17, 0.28],
