    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 11, qubit_DAC_attenuator1 = 2,
        ...
        if fridge == "QUIET":
            ...
            self.readout_cfg = {
                ...
                'res_freq_ge': np.array([6227.125, 6289.0, 6348.55, 6419.665, 6485.315, 6552.35]), #updated by Arianna 10/10, run 8
            ...
            # Qubit Configuration
            self.qubit_cfg = {
                "qubit_freq_ge": [4194.71, 3828.55, 6289.175, 4474.23, 4485.38, 5018.12], # Arianna 10/10, run 8
                # 'qubit_freq_ge': np.array([6227.187, 6289.175, 6348.55, 6419.665, 6485.315, 6552.35]),
                # 'rqubit_freq_ge': np.array([6227.187, 6289.175, 6348.55, 6419.665, 6485.315, 6552.35]),
                # 'rqubit_freq_ge': np.array([6227.187, 6289.175, 6348.55, 6419.665, 6485.315, 6552.35]),
                ...
                "qubit_gain_ge":  [0.005, 0.1, 0.005, 0.005, 0.005, 0.005],
                # "rqubit_gain_ge": [0.04, 1, 0.05, 0.08, 0.14, 0.17],
                # "rqubit_gain_ge": [0.04, 1, 0.05, 0.08, 0.14, 0.17],
                ...
                "qubit_freq_ef": [4020.47, 3650.68, 3999.01, 4302.33, 4313.20, 4848.81], # Arianna 10/13
                ...
                "qubit_gain_ef":  [0.0055, 0.1, 0.0077, 0.0045, 0.0095, 0.02],# [0.004, 0.0075, 0.0045, 0.008, 0.01],#
                "qubit_gain_fh": [0.00005, 0.01, 0.0075, 0.1, 0.15, 0.005],
                ...
                "pi_amp": [0.655, 0.581, 0.65, 0.65, 0.66, 0.69], # Arianna 10/10, run 8
                ...
                "pi_ef_amp": [0.427, 0.6664, 0.511, 0.7018, 0.6751, 0.589], # Arianna 3/27
                "pi_fh_amp": [0.563, 0.5694, 0.511, 0.7018, 0.6751, 0.589],  # Arianna 3/27
