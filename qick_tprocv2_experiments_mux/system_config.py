    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.readout_cfg = {
                ...
                # Changes related to the resonator output channel
                "mixer_freq": 5500, # [MHz]
                "res_freq_ge": [6187.91, 5828.47, 6074.56, 5959.294], #[6187.9 - 0.18, 5828.47 + 0.2, 6074.56 - 0.3375, 5959.284 - 0.09], #Run 34 #[6187.973, 5828.530, 6074.662, 5959.343], #Run 33
                "res_gain_ge": [0.116, 0.0935, 0.1162, 0.14], # Q1 opt, [0.2, 0.1, 0.15, 0.2], #[0.4, 0.4, 0.4, 0.4],  # [0.15]*4, #[1, 1, 1, 1],
                "res_length": 4.25, #[9.25, 5.5, 6.25, 7.0], #5 #4.6,  # 10,  # [us] (1.0 for res spec)
                "res_phase": [0] * 4,
            ...
            self.qubit_cfg = {
                ...
                "pi_amp": [0.715, 0.6647, 0.725, 0.705], #Found 9/3 #[1.0, 0.93, 0.77, 0.846],  # TO DO CHANGE THIS (11/26)
