...
class QICK_experiment:
    def __init__(self, folder, DAC_attenuator1 = 5, DAC_attenuator2 = 15, ADC_attenuator = 15, fridge = None):
        if fridge == "QUIET":
            ...
            # Qubit Configuration
            self.qubit_cfg = {
                "qubit_freq_ge": [4190.49, 3819.70, 4161.38, 4461.86, 4473.17, 4999.64],  # Joyce 3/11
                ...
                "pi_amp": [0.1206, 0.127, 0.1174, 0.1396, 0.1206, 0.158], #[0.6748, 0.634499, 0.76542, 0.7754, 0.6546, 0.9], #Joyce 3/11
