    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.qubit_cfg = {
                ...
                "qubit_gain_ge":  [0.01, 0.009, 0.028, 0.022, 0.075, 0.08], # run 9c: [0.01, 0.009, 0.028, 0.021, 0.16, 0.08]
                ...
                "sigma": [0.11, 0.07, 0.19, 0.21, 0.27, 0.98], #  run 9c: [0.11, 0.05, 0.19, 0.21, 0.35, 0.98] # DAC 2
