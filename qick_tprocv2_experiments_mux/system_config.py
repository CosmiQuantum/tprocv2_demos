...
class QICK_experiment:
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            # Qubit Configuration
            self.qubit_cfg = {
                "qubit_freq_ge":  [4226.11, 3853.61, 4197.05, 4506.61, 4519.0, 5050.78], #run 9, #[4194.77, 3828.69, 4173.69, 4474.23, 4485.38, 5018.12], # Arianna 10/10, run 8
                ...
                "qubit_gain_ge":  [0.02, 0.0165, 0.06, 0.05, 0.2, 0.25], #0.1 for Q4 # run 9, # [0.0135, 0.005, 0.005, 0.005, 0.082, 0.015] run 8
                ...
                "qubit_gain_ef":  [0.008, 0.018, 0.06, 0.03, 0.2, 0.16], # run 8: [0.0053, 0.01, 0.0077, 0.0045, 0.00955, 0.02],
                ...
                "sigma": [0.11, 0.07, 0.22, 0.22, 0.22, 0.85], # 19dB: [0.26, 0.43, 0.46, 0.42, 0.385, 1.01], # DAC 2 04/07 [us] for Gaussian Pulse (5+10 DAC atten for qubit). Updated on 7/17 by Arianna
                ...
                "sigma_ef": [0.08, 0.13, 0.28, 0.16, 0.22, 0.41], #run 9: updated all except Q5 # run 8: [0.1, 0.25, 0.2, 0.25, 0.17, 0.28],
