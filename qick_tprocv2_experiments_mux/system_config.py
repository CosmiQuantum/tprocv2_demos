    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.readout_cfg = {
                ...
                # Changes related to the resonator output channel
                "mixer_freq": 5500, # [MHz]
                "res_freq_ge": [6187.9, 5828.47, 6074.59, 5959.3], #[6187.9-0.143, 5828.47-0.143, 6074.59, 5959.3-0.143], #Run 34 #[6187.973, 5828.530, 6074.662, 5959.343], #Run 33
                "res_gain_ge": [0.75, 0.7, 0.8, 0.75], #[0.4, 0.4, 0.4, 0.4],  # [0.15]*4, #[1, 1, 1, 1],
                "res_length": 7.0, #[9.25, 5.5, 6.25, 7.0], #5 #4.6,  # 10,  # [us] (1.0 for res spec)
                "res_phase": [0] * 4,
            ...
            self.qubit_cfg = {
                "qubit_mixer_freq": 4300,  # [MHz]
                "qubit_freq_ge": [4923.9, 4764.5, 4577.1, 4782.3], #Run 34 start pt #[4921.5, 4761.7, 4575.8, 4784], #Found with QICK, run 33  # Freqs of Qubit g/e Transition
                "qubit_gain_ge": [0.2, 0.2, 0.2, 0.2],  # [0.008] * 4,#[0.2, 0.2, 0.2, 0.01], #[0.2] * 4,  #0.07
                "qubit_length_ge": 20,  # [us] for spec Pulse
                "qubit_phase": 0,  # [deg]
                "sigma": [0.6, 0.4, 0.65, 0.5], #[0.5, 0.35, 0.5 ,0.5], #[0.04, 0.025, 0.04, 0.03],  # [0.08, 0.15, 0.11, 0.09], # TO DO CHANGE THIS (11/26)
                "pi_amp": [0.68, 0.68, 0.69, 0.675], #Found 9/3 #[1.0, 0.93, 0.77, 0.846],  # TO DO CHANGE THIS (11/26)
