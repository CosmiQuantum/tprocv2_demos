    ...
    def __init__(self, folder, DAC_attenuator1 = 10, DAC_attenuator2 = 15, qubit_DAC_attenuator1 = 5,
        ...
        if fridge == "QUIET":
            ...
            self.qubit_cfg = {
                ...
                "qubit_gain_ge":  [0.01, 0.011, 0.033, 0.021, 0.04, 0.08], # [0.0135, 0.005, 0.005, 0.005, 0.082, 0.015] run 8
                ...
                "sigma_ef": [0.08, 0.13, 0.29, 0.17, 0.16, 0.41], #run 9: updated all except Q5 # run 8: [0.1, 0.25, 0.2, 0.25, 0.17, 0.28],
