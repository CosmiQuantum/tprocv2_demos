...
class DephasingProgram(AveragerProgramV2):
...
class DephasingMeasurement:
    ...
    def run(self, thresholding=False):
        ...
        echo = DephasingProgram(self.experiment.soccfg, reps=self.config['reps'], final_delay=self.config['relax_delay'],
                         cfg=self.config)
