...
class ResonanceSpectroscopy:
    ...
    def plot_results(self, fpts, fcenter, amps, reloaded_config = None, fig_quality = 100,exp_extension='_ge'):
        res_freqs = []
        ...
        if self.save_figs:
            outerFolder_expt = os.path.join(self.outerFolder, self.expt_name + exp_extension)
