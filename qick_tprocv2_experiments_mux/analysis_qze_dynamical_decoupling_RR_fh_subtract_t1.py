...
from analysis_008p5_dephasing_vs_time_plots_fh import DephasingVsTimeFH
...
top_folder_dates = ['fh_noise_transition_tests2025-06-06_00-27-37','fh_noise_transition_tests2025-06-06_08-58-56']#,'Statistics_ef_noise_gain_0p02_100nsNoisePulse_2025-06-05_09-28-35'

dephasing_vs_time = DephasingVsTimeFH(figure_quality, final_figure_quality, tot_num_of_qubits, top_folder_dates, save_figs, fit_saved,
...
date_times_dephasing_ef, dephasing_vals_ef, dephasing_fit_err_ef, dephasing_batch_nums_w_noise = dephasing_vs_time.run(return_errs=True,name='DD_ge_fh_noise',savefigs=True, filters=True, batch_nums=True,save_plot_folder='documentation')
...
date_times_t1_fh, t1_fh_vals, t1_fh_fit_err, t1_fh_batch_nums = dephasing_vs_time.run_T1(return_errs=True,name='T1_fh',savefigs=True, fit=True, batch_nums=True)
...
date_times_t1_fh_w_fh, t1_fh_vals_fh, t1_fh_fit_err_fh, t1_fh_batch_nums_w_noise = dephasing_vs_time.run_T1(return_errs=True,name='t1_fh_w_noise',savefigs=True, fit=True, batch_nums=True)
...
dephasing_vs_time.plot_with_errs_subtract_T1(
    ...
    show_legends=True, extra_label=' - $T1_{ge}$',save_name='t1_ge_subtracted_')
...
dephasing_vs_time.plot_with_errs_vs_everything_t1(date_times_t1_ge=date_times_t1_ge, t1_ge_vals=t1_ge_vals, t1_ge_fit_err=t1_ge_fit_err,
    ...
    date_times_t1_fh=date_times_t1_fh, t1_fh_vals=t1_fh_vals, t1_fh_fit_err=t1_fh_fit_err,
    date_times_t1_fh_w_fh=date_times_t1_fh_w_fh, t1_fh_vals_fh=t1_fh_vals_fh, t1_fh_fit_err_fh=t1_fh_fit_err_fh,
    show_legends=True)