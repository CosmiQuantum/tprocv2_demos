...
top_folder_dates = ['TLS_Studies_With_Opt/Q0', 'TLS_Studies_With_Opt/Q1', 'TLS_Studies_With_Opt/Q2',
                    'TLS_Studies_With_Opt/Q3', 'TLS_Studies_With_Opt/Q4', 'TLS_Studies_With_Opt/Q5']
# top_folder_dates = ['angle_test']
# date = 'angle_test'
date = 'TLS_Studies_With_Opt'
...
# date_times_pi_amps, pi_amps = pi_amps_vs_time.run(plot_depths=False, rolling_avg=False)
# date_times_pi_amps_rolling_avg, pi_amps_rolling_avg = pi_amps_vs_time.run(plot_depths=False, rolling_avg=True)
...
# date = 'TLS_Studies/Q2'  #only plot all of the data for one date at a time because there is a lot
# outerFolder = f"/data/QICK_data/{run_name}/" + date + "/"
...
# plotter.run(plot_res_spec = False, plot_q_spec = True, plot_rabi = False, rabi_rolling_avg=False, plot_ss = False, plot_t1 = False,
...
q_spec_vs_time.plot_hist(q_freqs, show_legends)
# ############################################## 05: Pi Amp vs Time Plots ###############################################
#pi_amps_vs_time.plot(date_times_pi_amps, pi_amps, show_legends)
# pi_amps_vs_time.plot_hist(date_times_pi_amps, pi_amps_rolling_avg, show_legends)
# pi_amps_vs_time.plot_histogram_heatmap(pi_amps, pi_amps_rolling_avg, show_legends)
#pi_amps_vs_time.plot_scatter_rolling_avg(pi_amps, pi_amps_rolling_avg, show_legends)
...
# temps_class_obj = TempCalcAndPlots(figure_quality, final_figure_quality, tot_num_of_qubits, top_folder_dates, save_figs,
#                  fit_saved, signal, run_name, outerFolder, FRIDGE)
#
# all_qubit_temps, all_qubit_times = temps_class_obj.run()
# temps_class_obj.plot_vs_time(all_qubit_times, all_qubit_temps,show_legends,ylabel = 'Temp (mK)', title='Temp vs time', save_name='temp')
#
...
# plotter = PlotMetricDependencies(run_name, tot_num_of_qubits, final_figure_quality)
#
